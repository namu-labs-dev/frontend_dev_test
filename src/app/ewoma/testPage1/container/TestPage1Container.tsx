    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#1F1F1F]">
            ...
            <main className="flex-grow flex flex-col p-6">
                ...
                <div className="flex flex-col mt-4">
                    <div className="flex items-center justify-center w-16 h-16 bg-[#2C2D30] rounded-full">
                        <img src="/svgs/proxima.svg" alt="Message Icon" className="w-11 h-11" />
                    </div>
            ...
            <Modal isModalOpen={isModalOpen} setModalOpen={setIsModalOpen}>
                <div className="flex flex-col p-5 bg-[#2C2D30] max-w-[340px] items-center justify-center">
                    <h2 className="text-2xl font-bold text-white mb-3 w-[50%]">Transaction processing</h2>
                    <img src="/svgs/transaction.svg" alt="Message Icon" className="w-full h-full" />
                    <p className="text-white mt-3 text-base">Uploading your transaction to the node. please wait for a moment...</p>
                    <p className="text-white text-base">This may take up to 2 minutes.</p>
                </div>
            </Modal>
        </div>
    );
